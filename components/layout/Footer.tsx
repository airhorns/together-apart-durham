    ...
    <div className="container">
      <div className="footer-wrapper">
        ...
        <p className="footer-paragraph">
          Because Ottawa kicks ass.{" "}
          <StaticLink href="/contact">Contact Us</StaticLink> if you see a
          mistake, want more information, or to start this for your own
          community!
          <br />
          This information is crowdsourced, so please excuse any inaccuracy and
