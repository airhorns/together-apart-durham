// imported from https://github.com/zeit/next.js/blob/canary/examples/with-sentry/utils/sentry.js
...
export default (release = process.env.SENTRY_RELEASE) => {
  ...
  const captureException = (err: any, ctx?: any) => {
